...
const enData = {
  translation: {
    SKILL_NAME: 'Pineapple Facts',
    GET_FACT_MESSAGE: 'Here\'s an odd fact about pineapples: ',
    HELP_MESSAGE: 'You can say tell me a pineapple fact, or, you can say exit... What can I help you with?',
    HELP_REPROMPT: 'What can I help you with?',
    FALLBACK_MESSAGE: 'Odd Facts skill can\'t help you with that.  It can help you discover facts about space if you say tell me a space fact. What can I help you with?',
    FALLBACK_REPROMPT: 'What can I help you with?',
    ERROR_MESSAGE: 'Sorry, an error occurred.',
    STOP_MESSAGE: 'Goodbye!',
    FACTS:
      [
        'Americans use the word pineapple to describe this fruit, but every non-english country calls it - Ananas.',
        'It takes almost 3 years for a single pineapple to reach maturation.',
        'Pineapples grow gorgeous pink and purple flowers called fruitlets, which produce berries.',
        'Pineapples grow underground, so only the stem is visble.',
        'Pineapple cores contain high levels of bromelain, a proteolytic enzyme, which has been shown to be an effective anti-inflammatory, muscle relaxant, and digestive aid, and it also includes chemicals that interfere with the growth of tumor cells.',
        'Pineapples were once believed to cause miscarriages, and a pregnant woman would need to eat about 10 whole pineapples for it to be a concern.'
      ],
  },
};
...
const enauData = {
  translation: {
    SKILL_NAME: 'Austrailian Odd Facts about Pineapples',
  },
};

const encaData = {
  translation: {
    SKILL_NAME: 'Canadian Odd Facts about Pineapples',
  },
};

const engbData = {
  translation: {
    SKILL_NAME: 'British Odd Facts about Pineapples',
  },
};

const eninData = {
  translation: {
    SKILL_NAME: 'Indian Odd Facts about Pineapples',
  },
};

const enusData = {
  translation: {
    SKILL_NAME: 'American Odd Facts about Pineapples',
  },
};
