# An Alexa Fact Skill about Pineapples
<img src="https://m.media-amazon.com/images/G/01/mobile-apps/dex/alexa/alexa-skills-kit/tutorials/quiz-game/header._TTH_.png" />

This Alexa skill is a basic fact skill about pineapples.
It provides fun for the whole family to enjoy and is guaranteed to make you smarter. Alexa will select a fact at random and tell it to the user when the skill is invoked.

## Getting Started
To invoke the skill just say "Alexa, launch Odd Facts" or Alexa, open Odd Facts" to get a fact. At anytime, you can stop by saying "Alexa, stop".
